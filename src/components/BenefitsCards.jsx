...
const BenefitsCards = () => {
  ...
  return (
    <div 
      ref={containerRef} 
      className={`flex ${isOverflowing ? 'justify-start' : 'justify-center'} items-center overflow-x-auto gap-[12px] xl:gap-[16px] self-stretch p-[16px] xl:pt-[80px] xl:pb-[0px] bg-[linear-gradient(107deg,_#17182F_0%,_#151628_67.29%)]`}>
