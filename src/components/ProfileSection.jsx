  ...
  return (
    <div className="hidden xl:flex items-center justify-end gap-[20px]">
      <div className="flex items-center gap-[8px] cursor-pointer">
        ...
        <div className="h-[40px] w-[40px] flex items-center justify-center rounded-[4px] bg-[radial-gradient(106.76%_124.95%_at_77.08%_-35.83%,_#262A50_32.6%,_#1D1F36_100%)] border border-1 border-[#2C3053]">
