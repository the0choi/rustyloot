import bannerHowDoesItWork from '../assets/images/bannerHowDoesItWork.png';
            ...
            <div className="w-[32px] lg:w-[40px] xl:w-[40px] h-[32px] lg:h-[40px] xl:h-[40px] flex items-center justify-center shrink-0 rounded-[4px] border border-1 border-[#2C3053] bg-[radial-gradient(106.76%_124.95%_at_77.08%_-35.83%,_#262A50_32.6%,_#1D1F36_100%)]">
              <div className="h-[16px] lg:h-[20px] xl:h-[20px] shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="21" viewBox="0 0 24 21" fill="none" className="w-full h-full">
                  ...
                  <path d="M6.68735 7.32926C5.21351 7.32926 3.16266 7.08297 1.90354 6.53301C1.53105 6.37841 1.19588 6.20285 0.900024 6.00967V8.06094C0.900024 8.58734 1.5173 9.17067 2.511 9.58342C3.40839 9.97546 5.15945 10.256 6.68735 10.256C6.78331 10.256 6.87409 10.2456 6.96906 10.2433C7.4005 9.07161 8.07793 8.0147 8.94674 7.13185C8.23791 7.26105 7.47869 7.32926 6.68735 7.32926Z" fill="#545784"/>
                  <path d="M6.96184 16.1031C6.8702 16.105 6.77973 16.1096 6.68739 16.1096C5.21355 16.1096 3.1627 15.8633 1.90359 15.3134C1.52413 15.156 1.15631 14.9574 0.900024 14.7901V16.8413C0.900024 17.7252 3.33024 19.0365 6.68735 19.0365C7.35263 19.0365 8.0026 18.9798 8.60871 18.8734C7.8953 18.0635 7.33585 17.1264 6.96184 16.1031Z" fill="#545784"/>
                  <path d="M6.57248 11.7171C5.10816 11.7051 3.13135 11.4595 1.90354 10.9232C1.52413 10.7658 1.15631 10.5672 0.900024 10.3999V12.4511C0.900024 12.9775 1.5173 13.5609 2.511 13.9736C3.38608 14.356 5.07157 14.6302 6.57175 14.6437C6.48893 14.1675 6.43573 13.6816 6.43573 13.1829C6.43573 12.6825 6.48914 12.1949 6.57248 11.7171Z" fill="#545784"/>
                </svg>
              </div>
            </div>
            <span className="min-w-[300px] sm:min-w-[0px] max-w-[300px] sm:max-w-[212px] lg:max-w-[290px] xl:max-w-[300px] self-stretch text-left text-[#6A6FA3] font-bold text-[11px] lg:text-[12px] xl:text-[13px] leading-[14px] lg:leading-[16px] xl:leading-[17px] tracking-[0.1px]">
